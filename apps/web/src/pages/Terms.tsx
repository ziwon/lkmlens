...
export default function Terms() {
  return (
    <Prose title="Terms">
      ...
      <p>
        LKMLens is a free, best-effort search and discovery layer over public
      ...
      <p>
        LKMLens is provided "as is," without warranty of any kind. Thread
        reconstruction, topic classification, and (when enabled) AI-generated
        summaries can be incomplete or incorrect. Nothing on LKMLens is a
      ...
      <p>
        ...
        email addresses, circumvent rate limits, or use LKMLens in a way that
      ...
      <p>
        These terms may change as LKMLens adds features such as accounts,
